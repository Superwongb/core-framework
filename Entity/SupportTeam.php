 ...
 * SupportTeam
 * 
 * @ORM\Entity(repositoryClass="Harryn\Jacobn\CoreFrameworkBundle\Repository\SupportTeamRepository")
...
class SupportTeam
{
     ...
     * Add lead
     *
     * @param \Harryn\Jacobn\CoreFrameworkBundle\Entity\UserInstance $lead
     *
     * @return SupportTeam
     */
    public function addLead(\Harryn\Jacobn\CoreFrameworkBundle\Entity\UserInstance $lead)
    {
        $this->leads[] = $lead;
     ...
     * @param \Harryn\Jacobn\CoreFrameworkBundle\Entity\UserInstance $lead
     */
    public function removeLead(\Harryn\Jacobn\CoreFrameworkBundle\Entity\UserInstance $lead)
    {
