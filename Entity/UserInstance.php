...
class UserInstance
{
    ...
    /**
     * @var \Harryn\Jacobn\CoreFrameworkBundle\Entity\SupportRole
     ...
     * Add userSavedReply
     *
     * @param \Harryn\Jacobn\CoreFrameworkBundle\Entity\EmailTemplates $userSavedReply
     *
     * @return UserInstance
     */
    public function addUserSavedReply(\Harryn\Jacobn\CoreFrameworkBundle\Entity\EmailTemplates $userSavedReply)
    {
     ...
     * @param \Harryn\Jacobn\CoreFrameworkBundle\Entity\EmailTemplates $userSavedReply
     */
    public function removeUserSavedReply(\Harryn\Jacobn\CoreFrameworkBundle\Entity\EmailTemplates $userSavedReply)
    {
     ...
     * Add userSavedFilter
     *
     * @param \Harryn\Jacobn\CoreFrameworkBundle\Entity\SavedFilters $userSavedFilter
     *
     * @return UserInstance
     */
    public function addUserSavedFilter(\Harryn\Jacobn\CoreFrameworkBundle\Entity\SavedFilters $userSavedFilter)
    {
     ...
     * @param \Harryn\Jacobn\CoreFrameworkBundle\Entity\SavedFilters $userSavedFilter
     */
    public function removeUserSavedFilter(\Harryn\Jacobn\CoreFrameworkBundle\Entity\SavedFilters $userSavedFilter)
    {
     ...
     * Set user
     *
     * @param \Harryn\Jacobn\CoreFrameworkBundle\Entity\User $user
     *
     * @return UserInstance
     */
     ...
     * Set supportRole
     *
     * @param \Harryn\Jacobn\CoreFrameworkBundle\Entity\SupportRole $supportRole
     *
     * @return UserInstance
     */
    public function setSupportRole(\Harryn\Jacobn\CoreFrameworkBundle\Entity\SupportRole $supportRole = null)
    {
     ...
     * Get supportRole
     *
     * @return \Harryn\Jacobn\CoreFrameworkBundle\Entity\SupportRole
     */
     ...
     *
     * @param \Harryn\Jacobn\CoreFrameworkBundle\Entity\SupportPrivilege $supportPrivilege
     *
     * @return UserInstance
     */
    public function addSupportPrivilege(\Harryn\Jacobn\CoreFrameworkBundle\Entity\SupportPrivilege $supportPrivilege)
    {
     ...
     * @param \Harryn\Jacobn\CoreFrameworkBundle\Entity\SupportPrivilege $supportPrivilege
     */
    public function removeSupportPrivilege(\Harryn\Jacobn\CoreFrameworkBundle\Entity\SupportPrivilege $supportPrivilege)
    {
     ...
     * @return UserInstance
     */
    public function addSupportGroup(\Harryn\Jacobn\CoreFrameworkBundle\Entity\SupportGroup $supportGroup)
    {
     ...
     * @param \Harryn\Jacobn\CoreFrameworkBundle\Entity\SupportGroup $supportGroup
     */
    public function removeSupportGroup(\Harryn\Jacobn\CoreFrameworkBundle\Entity\SupportGroup $supportGroup)
    {
     ...
     * Add leadSupportTeam
     *
     * @param \Harryn\Jacobn\CoreFrameworkBundle\Entity\SupportTeam $leadSupportTeam
     *
     * @return UserInstance
     */
    public function addLeadSupportTeam(\Harryn\Jacobn\CoreFrameworkBundle\Entity\SupportTeam $leadSupportTeam)
    {
     ...
     * @param \Harryn\Jacobn\CoreFrameworkBundle\Entity\SupportTeam $leadSupportTeam
     */
    public function removeLeadSupportTeam(\Harryn\Jacobn\CoreFrameworkBundle\Entity\SupportTeam $leadSupportTeam)
    {
     ...
     *
     * @param \Harryn\Jacobn\CoreFrameworkBundle\Entity\SupportGroup $adminSupportGroup
     *
     * @return UserInstance
     */
    public function addAdminSupportGroup(\Harryn\Jacobn\CoreFrameworkBundle\Entity\SupportGroup $adminSupportGroup)
    {
     ...
     * @param \Harryn\Jacobn\CoreFrameworkBundle\Entity\SupportGroup $adminSupportGroup
     */
    public function removeAdminSupportGroup(\Harryn\Jacobn\CoreFrameworkBundle\Entity\SupportGroup $adminSupportGroup)
    {
