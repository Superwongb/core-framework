...
Welcome to the <info>Jacobn Community</info> project! Jacobn Community is an <comment>open-source e-commerce helpdesk system</comment>
...
To start things off, here are a few commands to help you setup:
  ...
  * <fg=blue;options=bold;>Configuring your project:</>
    ...
    <comment>php bin/console jacobn:configure-helpdesk</comment>
...
Made with $love by the Jacobn Team. Happy helping :)
